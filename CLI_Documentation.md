...
```bash
python -m app.cli update_user --name "New Name" --password "newpass123"
```
...
Example:
```bash
python -m app.cli create-user --status COMPLETED --priority HIGH --due_date 2025-01-20
```
...
### **8. Overdue Tasks**
```bash
python -m app.cli overdue_tasks
```
